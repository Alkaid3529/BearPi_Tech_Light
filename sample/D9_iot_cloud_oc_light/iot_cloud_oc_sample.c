...
#define CONFIG_WIFI_SSID          "HUAWEI Mate 30 Pro 5G alkaid"                            //修改为自己的WiFi 热点账号

#define CONFIG_WIFI_PWD           "13233350210"                        //修改为自己的WiFi 热点密码
...
#define CONFIG_APP_DEVICEID       "656d3e1b585c81787ad54968_BearPi_HM_Nano"       //替换为注册设备后生成的deviceid

#define CONFIG_APP_DEVICEPWD      "bearpi123456"                                   //替换为注册设备后生成的密钥
